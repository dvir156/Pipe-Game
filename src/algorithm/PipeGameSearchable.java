...
public class PipeGameSearchable implements Searchable<MyState> {
    State<MyState> initialState;
    State<MyState> goalState;
    ArrayList<State<MyState>> possibleStates = new ArrayList();
    private Map<String, State<MyState>> states = new HashMap<String, State<MyState>>();
...
char[] TheOptionsOfRotate(String str){
    ...
    @Override
    public State<MyState> getInitialState() {
        return initialState;
    }
    @Override
    public State<MyState> getGoalState() {
        return goalState;
    }
    public void setGoalState(State<MyState> goal) {
        this.goalState = goal;
    }
    public void setInitialState(State<MyState> initialState) {
        this.initialState = initialState;
    }
    public PipeGameSearchable(Board<Character> board) {
        this.board = board;
    }
    public boolean ifCameFrom(Integer X, Integer Y, State<MyState> cameFrom) {
        if(cameFrom != null && cameFrom.getState() != null) {
            MyState cameFromState = cameFrom.getState();
    ...
    @Override
    public ArrayList<State<MyState>> getAllPossibleStates(State<MyState> s) {
    ...
    public State<MyState> getState(Integer x, Integer y, char value, Integer cost) {
        ...
        if (states.containsKey(key)) {
            ...
            MyState st = new MyState(x, y, value, cost);
            State<MyState> state1 = new State<MyState>();
            state1.setState(st);
            state1.setCost(cost);
